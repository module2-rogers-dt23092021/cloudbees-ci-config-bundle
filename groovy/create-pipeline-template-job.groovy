...
if (configOpsJob == null) {
  ...
  SCMSource scm = new GitSCMSource("https://github.com/module2-rogers-dt23092021/pipeline-template-catalog.git");
      ...
      <instance>
        ...
        <values class="tree-map">
          ...
          <entry>
            ...
            <string>module2-rogers-dt23092021</string>
          </entry>
          <entry>
        ...
        <data>
          <jenkins.branch.BranchSource>
            <source class="org.jenkinsci.plugins.github_branch_source.GitHubSCMSource" plugin="github-branch-source@2.8.3">
              ...
              <repoOwner>module2-rogers-dt23092021</repoOwner>
              <repository>pipeline-template-catalog</repository>
              <repositoryUrl>https://github.com/module2-rogers-dt23092021/pipeline-template-catalog.git</repositoryUrl>
              <traits>
